...
if( !class_exists('trydo_Info_Widget') ){
    class trydo_Info_Widget extends WP_Widget{
    	/**
            ...
            <div class="rt-ft-address">
                <div class="address">
                    ...
                    <?php endif ?>
                        ...
                        <?php endif ?>
                        <?php if (!empty($email)): ?>
                            <p><i class="fas fa-envelope"></i> <a href="mailto:<?php echo esc_html($email); ?>"><?php echo esc_html($email); ?></a></p>
                        <?php endif ?>
                        <?php if (!empty($phone)): ?>
                            <p><i class="fas fa-phone-square"></i> <a href="tel:<?php echo esc_html($phone); ?>"><?php echo esc_html($phone); ?></a></p>
                        <?php endif ?>
                </div>
            </div>
        ...
        public function form($instance){ 
        	...
        	?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php echo esc_html__('Title:' ,'trydo') ?></label>
			...
			<div class="image_box_wrap" style="margin:20px 0 15px 0; width: 100%;">
				<button class="button button-primary author_info_image">
					<?php esc_html_e('Upload Logo', 'trydo'); ?>
				</button>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('content')); ?>"><?php echo esc_html__('Content:' ,'trydo') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php echo esc_html__('Address:' ,'trydo') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php echo esc_html__('Email:' ,'trydo') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php echo esc_html__('Phone:' ,'trydo') ?></label>
...
function trydo_Info_Widget(){
    register_widget('trydo_Info_Widget');
}
add_action('widgets_init','trydo_Info_Widget');