...
?>
<header class="header-area sticky-bg-black formobile-menu black-logo-version <?php echo esc_attr($header_sticky); ?> <?php echo esc_attr($header_transparent); ?>">
                ...
                <?php if (isset($trydo_options['trydo_logo_type'])): ?>
                    <a href="<?php echo esc_url(home_url('/')); ?>"
                        ...
                        <?php if ('image' == $trydo_options['trydo_logo_type']): ?>
                            ...
                            <img class="logo-normal" src="<?php echo esc_url($trydo_options['trydo_head_logo']['url']); ?>"
